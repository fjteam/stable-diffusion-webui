                    ...
                    if category == "sampler":
                        ...
                        with FormRow():
                            with gr.Column(elem_id="txt2img_column_size", scale=4):
                                width = gr.Slider(minimum=1024, maximum=2048, step=8, label="Width ", value=1024, elem_id="txt2img_width")
                                height = gr.Slider(minimum=1024, maximum=2048, step=8, label="Height ", value=1024, elem_id="txt2img_height")
                    ...
                    if category == "sampler":
                        ...
                        with FormRow():
                            with gr.Column(elem_id="img2img_column_size", scale=4):
                                selected_scale_tab = gr.State(value=1)
                                ...
                                with gr.Tabs():
                                    ...
                                    with gr.Tab(label="Resize to", elem_id="img2img_tab_resize_to") as tab_scale_to:
                                        with FormRow():
                                            with gr.Column(elem_id="img2img_column_size", scale=4):
                                                width = gr.Slider(minimum=64, maximum=2048, step=8, label="Width", value=1024, elem_id="img2img_width")
                                                height = gr.Slider(minimum=64, maximum=2048, step=8, label="Height", value=1024, elem_id="img2img_height")
        ...
        with gr.Row(variant="compact", equal_height=False):
            with gr.Tabs(elem_id="train_tabs"):
                ...
                with gr.Tab(label="Preprocess images", id="preprocess_images"):
                    ...
                    process_width = gr.Slider(minimum=64, maximum=2048, step=8, label="Width", value=1024, elem_id="train_process_width")
                    process_height = gr.Slider(minimum=64, maximum=2048, step=8, label="Height", value=1024, elem_id="train_process_height")
                ...
                with gr.Tab(label="Train", id="train"):
                    ...
                    training_width = gr.Slider(minimum=64, maximum=2048, step=8, label="Width", value=1024, elem_id="train_training_width")
                    training_height = gr.Slider(minimum=64, maximum=2048, step=8, label="Height", value=1024, elem_id="train_training_height")
